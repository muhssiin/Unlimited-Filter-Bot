...
async def cb_handler(client, query):
    ...
    if query.data == "start_data":
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("How to Deploy?", url="https://t.me/1453255875/2"),
                    InlineKeyboardButton("About Me", callback_data="about_data")
                ],
                [
                    InlineKeyboardButton("BOT Channel", url="https://t.me/MCubeMediaOfficial"),
                    InlineKeyboardButton("Support Group", url="https://t.me/MCubeMediaOfficial")
                ]
            ]
        )
            ...
            [
                [
                    InlineKeyboardButton(
                        "SOURCE CODE", url="https://t.me/1453255875/7")
                ],
                [
